...
void transformations() {
	int op, n, op2, ch;
	vector<vector<double>> points, obj1, obj2;
	...
	cout << "Transformation 1";
		...
		case 1: {
			...
			cin >> tx >> ty;
			for (int i = 0; i < n; i++) {
				obj1.push_back(translate(tx, ty, points[i][0], points[i][1]));
			}
			draw_object(obj1, 1);
			break;
		}
		case 2: {
			...
			if (op2 == 1) {
				...
				cin >> xf >> yf;
				for (int i = 0; i < n; i++) {
					obj1.push_back(rotate_fixed_point(theta, xf, yf, points[i][0], points[i][1]));
				}
			}
			else {
				for (int i = 0; i < n; i++) {
					obj1.push_back(rotate(theta, points[i][0], points[i][1]));
				}
			}
			draw_object(obj1, 1);
			break;
		...
		case 3: {
			...
			if (op2 == 1) {
				...
				cin >> xf >> yf;
				for (int i = 0; i < n; i++) {
					obj1.push_back(scale_fixed_point(sx, sy, xf, yf, points[i][0], points[i][1]));
				}
			}
			else {
				for (int i = 0; i < n; i++) {
					obj1.push_back(scale(sx, sy, points[i][0], points[i][1]));
				}
			}
			draw_object(obj1, 1);
			break;
		...
		case 4: {
			...
			if (op2 == 1) {
				...
				cin >> yf;
				for (int i = 0; i < n; i++) {
					obj1.push_back(shearX(shx, shy, yf, points[i][0], points[i][1]));
				}
			}
			else {
				cout << "Enter xref: ";
				cin >> xf;
				for (int i = 0; i < n; i++) {
					obj1.push_back(shearY(shx, shy, xf, points[i][0], points[i][1]));
				}
			}
			draw_object(obj1, 1);
			break;
		...
		case 5: {
			...
			if (op2 == 1) {
				for (int i = 0; i < n; i++) {
					obj1.push_back(reflectX(points[i][0], points[i][1]));
				}
			}
			else if (op2 == 2) {
				for (int i = 0; i < n; i++) {
					obj1.push_back(reflectY(points[i][0], points[i][1]));
				}
			}
			else if (op2 == 3) {
				for (int i = 0; i < n; i++) {
					obj1.push_back(reflectXY(points[i][0], points[i][1]));
				}
			}
			else if (op2 == 4) {
				for (int i = 0; i < n; i++) {
					obj1.push_back(reflectOrig(points[i][0], points[i][1]));
				}
			}
			draw_object(obj1, 1);
			break;
		...
		case 1: {
			...
			cin >> tx >> ty;
			for (int i = 0; i < n; i++) {
				obj2.push_back(translate(tx, ty, obj1[i][0], obj1[i][1]));
			}
			draw_object(obj2, 2);
			break;
		}
		case 2: {
			...
			if (op2 == 1) {
				...
				cin >> xf >> yf;
				for (int i = 0; i < n; i++) {
					obj2.push_back(rotate_fixed_point(theta, xf, yf, obj1[i][0], obj1[i][1]));
				}
			}
			else {
				for (int i = 0; i < n; i++) {
					obj2.push_back(rotate(theta, obj1[i][0], obj1[i][1]));
				}
			}
			draw_object(obj2, 2);
			break;
		...
		case 3: {
			...
			if (op2 == 1) {
				...
				cin >> xf >> yf;
				for (int i = 0; i < n; i++) {
					obj2.push_back(scale_fixed_point(sx, sy, xf, yf, obj1[i][0], obj1[i][1]));
				}
			}
			else {
				for (int i = 0; i < n; i++) {
					obj2.push_back(scale(sx, sy, obj1[i][0], obj1[i][1]));
				}
			}
			draw_object(obj2, 2);
			break;
		...
		case 4: {
			...
			if (op2 == 1) {
				...
				cin >> yf;
				for (int i = 0; i < n; i++) {
					obj2.push_back(shearX(shx, shy, yf, obj1[i][0], obj1[i][1]));
				}
			}
			else {
				cout << "Enter xref: ";
				cin >> xf;
				for (int i = 0; i < n; i++) {
					obj2.push_back(shearY(shx, shy, xf, obj1[i][0], obj1[i][1]));
				}
			}
			draw_object(obj2, 2);
			break;
		...
		case 5: {
			...
			if (op2 == 1) {
				for (int i = 0; i < n; i++) {
					obj2.push_back(reflectX(obj1[i][0], obj1[i][1]));
				}
			}
			else if (op2 == 2) {
				for (int i = 0; i < n; i++) {
					obj2.push_back(reflectY(obj1[i][0], obj1[i][1]));
				}
			}
			else if (op2 == 3) {
				for (int i = 0; i < n; i++) {
					obj2.push_back(reflectXY(obj1[i][0], obj1[i][1]));
				}
			}
			else if (op2 == 4) {
				for (int i = 0; i < n; i++) {
					obj2.push_back(reflectOrig(obj1[i][0], obj1[i][1]));
				}
			}
			draw_object(obj2, 2);
			break;
